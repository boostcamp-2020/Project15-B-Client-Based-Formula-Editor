...
export default function TutorialMain({ slide, handleSlideUp, handleSlideDown, handleSlideEnd }) {
	return (
		<Layout slide={slide}>
			...
			/>
			<TutorialPage
				imageURL={`${PREFIX}/FormulaRepresentation.gif`}
				title="이곳에서 원하시는 수식을 편집할 수 있습니다."
				handleSlideUp={handleSlideUp}
				handleSlideDown={handleSlideDown}
			/>
			<TutorialPage
				imageURL={`${PREFIX}/FormulaRepresentation_top.gif`}
				title="수식을 작성하면서 필요한 도구들을 사용할 수 있습니다."
				handleSlideUp={handleSlideUp}
				handleSlideDown={handleSlideDown}
			/>
			<TutorialPage
				imageURL={`${PREFIX}/LatexRepresantation.gif`}
				title="LaTeX 코드를 입력하여 수식을 만들 수 있습니다."
				handleSlideUp={handleSlideUp}
				handleSlideDown={handleSlideDown}
			/>
			<TutorialPage
				imageURL={`${PREFIX}/SideBar_character.gif`}
				title="수식에 필요한 기호나 연산자 등을 가져다 사용할 수 있습니다."
				handleSlideUp={handleSlideUp}
				handleSlideDown={handleSlideDown}
			/>
			<TutorialPage
				imageURL={`${PREFIX}/SideTab_top.gif`}
			...
			/>
			<TutorialPage
				imageURL={`${PREFIX}/SideTab_bottom.gif`}
